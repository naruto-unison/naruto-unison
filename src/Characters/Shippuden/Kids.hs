...
cs =
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.cost      = k [Tai]
        , Skill.effects   =
          [ p XEnemies $ whenM (userHas "Seal") $ damage 10
          ,  p Enemy do
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ p Enemy    $ damage 30
          , p XEnemies $ whenM (userHas "Three-Headed Wolf")  $ damage 20
          , p REnemy   $ whenM (channeling "Man-Beast Clone") $ damage 20
          ]
        }
      ]
    , [ Skill.new
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.cooldown  = 2
        , Skill.start     =
          [ p Self $ vary "Insect Swarm" "Chakra Leech"
          ,  p Enemy do
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 2
        , Skill.effects   =
          [ p Self $ bomb' "Barricaded" (-1) []
                           [ p Expire $ self $ gain [Blood] ]
          ,  p Ally $ apply 1 [Parry All $ Play do
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ p Self    $ tag 4
          , p Enemies $ trap 4 OnHarm addStack
          ]
        }
      ]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 2
        , Skill.effects   =
          [ p Enemy $ trap (-3) (OnAction All) $ apply 1 [Expose, Uncounter] ]
        }
      ]
  ...
  , Character
    ...
    , [ Skill.new
      ...
      , Skill.new
        ...
        , Skill.effects   =
          [ p Enemy $ damage 30
          , p Self  $ replicateM_ 2 $ hide' "calories" 0 [Exhaust All]
          ]
        }
      ]
    , [ Skill.new
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ p Enemy do
                ...
                bomb (-1) [Replace 1 All 0 False] [ p Done $ damage 15 ]
          ]
        }
      ]
    , [ Skill.new
        ...
        , Skill.cooldown  = 3
        , Skill.effects   =
          [ p Enemies $ apply 3 [Reveal, Build (-15), Unreduce 15] ]
        }
      ]
    , [ Skill.new
  ...
  , let loadout = [0, 0, 0]
    ...
    , [ Skill.new
        ...
        , Skill.cost      = k [Rand]
        , Skill.effects   =
          [ p Allies $ apply 1 [Invulnerable Physical] ]
        }
      , Skill.new
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.cost      = k [Blood]
        , Skill.effects   =
          [ p Enemies $ apply 2 [Expose]
          , p Self    $ apply 1 [Parry All $ Play $ self $
      ...
      , Skill.new
        ...
        , Skill.effects   =
          [ p Enemy do
                deplete 1
                damage 5
          ,  p Self $ vary' 1 "Eight Trigrams Sixty-Four Palms"
                              "Pressure Point Strike"
          ]
        }
      ]
  ...
  , Character
        ...
        , Skill.effects   =
          [ p Enemy do
                ...
                if has then do
                    ...
                    bomb (1 + bonus) [Stun NonMental] [ p Expire $ pierce 20 ]
          ]
        }
      ]
    , [ Skill.new
        ...
        , Skill.cooldown  = 2
        , Skill.effects   =
          [ p Allies $ apply 1 [Parry All $ Play do
                tag 1
                allies do
                    defend 0 15
    ...
    , Character
      ...
      [ [ Skill.new
          ...
          , Skill.channel   = Action 3
          , Skill.start     =
            [ p Self $ vary "Sasori Surrogate" "Hidden Coil Strike" ]
          , Skill.effects   =
            [ p Enemy $ damage 15 ]
          }
        , Skill.new
        ...
        , Skill.new
          ...
          , Skill.effects   =
              [ p Enemy do
                    ...
                    pierce (20 + bonus)
              , p Self $ vary "Kuroari Trap" baseVariant
              ]
          }
        ]
      , [ Skill.new
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.start     = [ p XAlly $ everyone $ remove "Blood Sample"
                            • tag' "Blood Sample" 0)
                    , p Ally $  sacrifice 0 15
                    ]
        }
      ]
    , [ Skill.new
        ...
        , Skill.cost      = k [Nin, Rand]
        , Skill.cooldown  = 1
        , Skill.effects   = [ p Enemy $ pierce 35 • apply 2 [Plague] ]
        }
      ]
    , [ Skill.new
        ...
        , Skill.cost      = k [Nin]
        , Skill.cooldown  = 1
        , Skill.effects   = [ p Enemy $ afflict 20
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 1
        , Skill.effects   =
          [ p XAlly $ trap 1 OnRes $ setHealth 15 ]
        }
      ]
