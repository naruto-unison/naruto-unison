...
characters =
  [ Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Self do
                gain [Rand]
                hide 1 skillName [ Alternate "Major Summoning: Manda"
                                             "Paralyzing Bite"
                                 ]
          ]
        }
      , Skill.new
        ...
        , Skill.cooldown  = 1
        , Skill.effects   =
          [ To Enemy $ bomb 1 skillName [ Stun All ] [ To Expire $ damage 25 ] ]
        }
      ]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide 1 skillName [ Alternate "Major Summoning: Gamabunta"
                                                   "Toad Oil Bomb"
                                       ]
          ]
        }
      , Skill.new
        ...
        , Skill.cooldown  = 1
        , Skill.effects   =
          [ To Enemies $ apply 2 skillName [ Afflict 15 ] ]
        }
      ]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Allies $ heal 5
          , To Self $ hide 1 skillName [ Alternate "Major Summoning: Katsuyu"
                                                   "Slug Division"
                                       ]
          ]
        }
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.cost      = [Nin, Rand]
        , Skill.effects   =
          [ To Enemy $ apply Permanent skillName [ Afflict 40
                                                 , Stun All
                                                 , Expose
                                                 ]
          , To Self $ apply Permanent skillName [ Afflict 20
                                                , Stun All
                                                ]
          ]
        }
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide 1 skillName [ Alternate "Major Summoning: Enma"
                                                   "Adamantine Prison"
                                       ]
          ]
        }
      , Skill.new
        ...
        , Skill.cooldown  = 4
        , Skill.effects   =
          [ To Allies $ apply 1 skillName [ Endure
