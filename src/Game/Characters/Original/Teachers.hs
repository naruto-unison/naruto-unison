...
characters =
  ...
  , Character
    ...
    , [ Skill.new
      ...
      , Skill.new
        ...
        , Skill.require   = [TargetHas AtLeast 1 "Dual Pin"]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Self do
                bonus <- 5 `bonusPer` user amount "Illusion"
                defend Permanent (10 + bonus)
                remove "Illusion"
          ]
        }
      ]
    , [ Skill.new
      ...
      , Skill.new
        ...
        , Skill.require   = [TargetHas AtLeast 1 "Demonic Illusion: Sylvan Fetters"]
        , Skill.classes   = [Mental, Melee]
        , Skill.cost      = [Rand]
        , Skill.effects   =
          [ To Enemy $ pierce 30 ]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.desc      = "Using a top-of-the-line Hidden Sand Village flak jacket, Baki provides 50 permanent destructible defense to himself or an ally. While the target has destructible defense from this skill, they ignore harmful non-damaging status effects."
        , Skill.classes   = [Physical]
