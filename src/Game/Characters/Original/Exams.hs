...
characters =
  [ Character
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 4
        , Skill.effects   =
          [ To Self $ apply 2 skillName [ Endure
                                        , Focus
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Self do
                defend 3 30
                apply 3 skillName [ Invulnerable Mental
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy do
                ...
                apply Permanent skillName [ Bleed [NonAffliction] Flat 5
                                          , Weaken [All] Flat 5
                                          ]
          ]
        }
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.classes   = [Physical, Melee, Soulbound, Unremovable, Uncounterable, Unreflectable]
        , Skill.cost      = [Rand, Rand]
        , Skill.cooldown  = 4
        , Skill.effects   =
          [ To Enemy do
