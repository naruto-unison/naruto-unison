...
characters =
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = [UserHas AtLeast 1 "Umbrella"]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = [UserHas AtLeast 1 "Slicing Sound Wave"]
        , Skill.classes   = [Physical, Ranged]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = [TargetHas AtLeast 1 "Soft Physique Modification"]
