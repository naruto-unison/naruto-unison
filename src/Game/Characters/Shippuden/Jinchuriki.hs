...
characters =
  ...
  , Character
    ...
    , [ Skill.new
        { Skill.name      = "Lariat"
        , Skill.desc      = "As the eight-tailed beast's chakra surrounds Killer B, he deals 20 piercing damage to one enemy!\nSpends an additional arbitrary chakra during [Acrobat]'s funky flow to deal 20 extra damage with a piercing blow!"
        , Skill.classes   = [Physical, Melee]
        , Skill.cost      = [Tai]
        , Skill.effects   =
          [ To Enemy do
  ...
  , Character
    ...
    , [ Skill.new
        { Skill.name      = "Lariat"
        , Skill.desc      = "Rushing an enemy, B deals 20 piercing damage to them and increases their cooldowns by 1 turn for 1 turn."
        , Skill.classes   = [Physical, Melee]
        , Skill.cost      = [Tai, Rand]
        , Skill.cooldown  = 1
        , Skill.effects   =
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = [UserHas AtLeast 1 "Four-Tailed Transformation"]
