...
characters =
  [ Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide Permanent skillName [ Alternate "Frog Kumite"
                                                 "Rasen Shuriken"
                                     ]
          ]
        }
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide Permanent skillName [ Alternate "Natural Energy Assault"
                                                 "Rasengan Barrage"
                                     ]
          ]
        }
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy $ damage 15
          , To Self $ hide 1 skillName [ Alternate "Sasori Surrogate"
                                         "Hidden Coil Strike"
                             ]
          ]
        , Skill.stunned   =
        ...
        , Skill.effects   =
          [ To Enemy do
                ...
                whenM (target has "Kuroari Trap") do
                    remove "Kuroari Trap"
                    apply 1 "Kuroari Ambush" [ Stun All
                                              , Alone
                                              , Duel userSlot
                                              ]
          ]
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 5
        , Skill.effects   =
          [ To Self $ hide Permanent skillName [ Alternate "Kuroari Trap"
                                                 "Iron Maiden"
                                     ]
          , To Enemy $ bomb 5 skillName []
                [ To Expire do
                    userSlot <- user slot
                    apply 1 "Kuroari Ambush" [ Stun All
                                              , Alone
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To XAllies do
                userSlot <- user slot
                apply 1 skillName [ Redirect userSlot ]
          ]
        , Skill.end       =
          [ To Self $ targeting XAllies $ remove skillName ]
        }
      ]
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.start     =
          [ To Self $ hide Permanent skillName [ Alternate "Sage Transformation"
    ...
    , [ Skill.new
        ...
        , Skill.desc      = "Kabuto administers chakra-rich blood to himself or an ally, restoring 15 health for 3 turns, resetting the cooldowns of the target's instant skills, and curing them of bane effects. While being healed, the target is invulnerable to bane skills."
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy $ damage 10
          , To Self $ apply 1 skillName [ Reduce [All] Percent 20 ]
          ]
        }
      ]
    , [ Skill.new
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.cooldown  = 4
        , Skill.effects   =
          [ To Self $ apply 3 skillName [ Reduce [Affliction] Flat 15
                              , Alternate "Chidori"
                                          "Blazing Arrow"
                              , Alternate "Amaterasu"
                                          "Yasaka Beads"
        ...
        , Skill.effects   =
          ...
          , To Self do
                trap -1 (OnHarmed Physical) $
                    remove skillName
                bomb -1 skillName [ Reduce [Physical] Flat 15 ]
                    [ To Expire do
                          hide 1 skillName []
          ...
          let
            ...
            amaterasu = do
                trapWith [Bypassing] Permanent OnInvulnerable do
                    ...
                    remove skillName
                bombWith [Bypassing] Permanent skillName [ Afflict 5 ]
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy do
                ...
                userSlot <- user slot
                apply 1 skillName [ Taunt userSlot ]
          , To Self $ hide Permanent skillName [ Alternate "Poisonous Chain Skewer"
                                                 "Impale"
                                     ]
          ]
        }
    ...
    , [ Skill.new
        ...
        , Skill.dur       = Action 3
        , Skill.start     =
          [ To Self $ hide Permanent skillName [ Alternate "Flamethrower Jets"
                                                 "Cutting Water Jets"
                                     ]
          ]
        , Skill.effects   =
    ...
    , [ Skill.new
      ...
      , Skill.new
        ...
        , Skill.effects   =
          [ To Enemy do
                damage 30
                bomb 2 "Complex Toxin" [] [ To Expire $ apply 1 skillName [ Stun All ] ]
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.cooldown  = 3
        , Skill.effects   =
          [ To Allies $ apply 2 skillName [ Reduce [All] Flat 10 ]
          , To Enemies $ apply 2 skillName [ Snare 1 ]
          ]
        }
      ]
    , [ Skill.new
        ...
        , Skill.cost      = [Rand]
        , Skill.effects   =
          [ To Self $ hide Permanent skillName [ Alternate "Paper Bomb"
                                                 "Paper Shuriken"
                                     ]
          , To Enemy do
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy do
                damage 20
                pierce 15
                apply 1 skillName [ Throttle 1 Counters ]
          ]
        }
      ]
    , [ Skill.new
