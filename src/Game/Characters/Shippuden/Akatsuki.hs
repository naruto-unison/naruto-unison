...
characters =
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide Permanent [ Alternate "C1: Bird Bomb"
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          ...
          , To Self $ hide Permanent [ Alternate "C4: Karura"
                                                 "C0: Ultimate Art"
                                     ]
          ]
        }
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects   =
          [ To Self $ apply Permanent [ Alternate "Jashin Sigil"
                                                  "First Blood"
                                      ]
          ]
        }
  ...
  , Character
    ...
    [ [ Skill.new
        ...
        , Skill.effects  =
          ...
          , To Self $ hide Permanent [ Alternate "Pressure Damage"
                                                 "Searing Migraine"
                                     ]
          ]
        }
    ...
    , [ Skill.new
        ...
        , Skill.effects   =
          [ To Enemy $ pierce 30
          , To Self $ hide Permanent [ Alternate "False Darkness"
                                                 "Blast Flames"
                                     ]
          ]
        }
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.start     =
          [ To Enemy purge
          , To Self $ hide Permanent [ Alternate "Missile Salvo"
                                                 "Head Cannon"
                                     ]
          ]
        , Skill.effects   =
