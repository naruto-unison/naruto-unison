...
characters =
  [ Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = UserHas 2 "Scattered Rock"
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = TargetHas 0 "Acupuncture"
        , Skill.classes   = [Physical, Ranged]
        , Skill.cost      = [Nin]
        , Skill.cooldown  = 2
        , Skill.effects   =
    ...
    , [ Skill.new
        ...
        , Skill.require   = UserDefense 0 "Crystal Ice Mirrors"
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = TargetHas 1 "Executioner's Butchering"
  ...
  , Character
    ...
    , [ Skill.new
        ...
        , Skill.require   = TargetHas 1 "Needle Stitching"
        , Skill.classes   = [Physical, Ranged]
        , Skill.cooldown  = 2
        , Skill.effects   =
          [ To Enemies do
  ...
  , let
    ...
    [ [ Skill.new
        ...
        , Skill.cooldown   = 3
        , Skill.effects    =
          [ To Enemies $ barricade' 3 (\n -> damage n) (apply 1 [Silence]) 25 ]
        }
      ]
    , [ Skill.new
      ...
      , Skill.new
        ...
        , Skill.require   = TargetHas 1 "Human Path"
